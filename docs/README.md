...
![Add something amazing](https://github.com/workupsrl/nova-flexible-content/raw/master/confirm_remove.png)
...
2. Your custom layout class must implement `Spatie\MediaLibrary\HasMedia` and use the `Workup\NovaFlexibleContent\Concerns\HasMediaLibrary` trait.
